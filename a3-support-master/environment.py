...
class Environment:
    ...
    # return [0]/[2,0] ，返回中可能出现随机事件，即多倍移动/旋转
    # 已被集成（应用随机事件）
    ...
    # return (cost, state) 用于已知 real_action 之后
    # 无随机性
    # 已被集成（perform_action中）
    def __apply_dynamics(self, state, movement):
        ...
        else:  # movement == FORWARD or movement == REVERSE
